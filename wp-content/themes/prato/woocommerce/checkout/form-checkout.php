                        ...
                        <div class="form-row">
                            ...
                            <div class="form-row-inputs">
                                <div class="form-input-row address-field" id="billing_address_2_field" data-priority="60">
                                    ...
                                    <input type="text" name="billing_address_2" id="billing_address_2" autocomplete="address-line2" placeholder="г. Киев, ул. Артема 33, кв. 33">
                                </div>
                            ...
                            <div class="form-input-row notes" id="order_comments_field">
                                ...
                                <div class="form-input-row">
                                    ...
                                    <div class="payment-methods">
                                        <input id="payment_method_cod" type="radio" name="payment_method" value="cod"
