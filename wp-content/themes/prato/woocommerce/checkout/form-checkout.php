                ...
                <form name="checkout" method="post" class="checkout woocommerce-checkout" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data">
                    <div class="form-row">
                        ...
                        <div class="form-row-inputs">
                            <div class="form-input-row" id="billing_first_name_field">
                            ...
                            <div class="form-input-row" id="billing_email_field">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-row-inputs">
                            <div class="form-input-row" id="shipping_address_1_field">
                                <label for="shipping_address_1">Адрес доставки:</label>
                                <textarea type="text" class="input-text " name="shipping_address_1" id="shipping_address_1" autocomplete="address-line1" placeholder="г. Киев, ул. Артема 33, кв. 33"></textarea>
                            </div>
...
<!--                        <a href="--><?//echo get_permalink( get_page_by_title( 'Cart' ) )?><!--">Корзина</a>-->
<!--                        <button type="submit" class="button alt" name="woocommerce_checkout_place_order" id="place_order" value="Завершить" data-value="Завершить">Завершить</button>-->
                    </div>
                </form>
            </div>
        </div>
